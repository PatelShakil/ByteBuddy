...
import com.shakilpatel.bytebuddy.data.models.error.VoteModel
import com.shakilpatel.bytebuddy.data.models.user.UserModel
import com.shakilpatel.bytebuddy.data.notification.Cons
                                        ...
                                        commonRepo.getUserNameFromUid(auth.uid.toString()) { name ->
                                            commonRepo.getTokenFromUid(ans.userId) { token ->
                                                com.shakilpatel.bytebuddy.data.notification.Cons.sendNotification(
                                                    com.shakilpatel.bytebuddy.data.notification.PushNotification(
                                                        com.shakilpatel.bytebuddy.data.notification.NotificationData(
                                                            faq.title,
